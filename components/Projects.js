      ...
      <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 md:py-24 lg:px-8 lg:py-28">
        ...
        >
          <div className="max-w-2xl">
            ...
            >
              A diverse portfolio of projects that demonstrate our commitment to
        ...
        {/* Bento grid */}
        <div className="grid grid-cols-1 gap-5 auto-rows-[260px] md:grid-cols-2 lg:grid-cols-4 lg:gap-6">
          {images.map((image, index) => (
            <ProjectCard key={image.title} image={image} index={index} />
          ))}
        </div>
      </div>
    </section>
