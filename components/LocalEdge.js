...
import { MapPin, Languages, Wallet, Clock, Users, Handshake, ArrowRight } from 'lucide-react';
...
const defaultPoints = [
  {
    ...
    description: 'Meet us in person in Blue Area, Centaurus Mall, or I-9 Markaz — or we visit you in Bahria Town, DHA, or Gulberg.',
  },
  {
    icon: Languages,
    title: 'Support in Urdu & English',
    description: 'Clear communication in your language, whether you are in Lahore, Karachi, or Peshawar. No lost-in-translation moments.',
  },
  {
    icon: Wallet,
    title: 'Local payments, PKR invoices',
    description: 'Pay by bank transfer, JazzCash, or Easypaisa. We issue proper FBR-compliant invoices in Pakistani Rupees.',
  },
  {
    icon: Clock,
    title: 'Fast local response',
    description: 'No timezone gaps. Same-day replies, on-site visits, and a team that understands Pakistani consumer behaviour.',
  },
];

const LocalEdge = ({
  eyebrow = 'Our local edge',
  titleA = 'Why choose a local',
  titleB = 'Islamabad / Rawalpindi tech partner?',
  description = 'A Pakistani team that gets Pakistani business — local meetings, local payments, Urdu support, and knowledge of how customers really buy here.',
        ...
        <div className="grid items-start gap-12 lg:grid-cols-12 lg:gap-16">
          ...
          <div className="lg:col-span-7">
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              {points.map(({ icon: Icon, title, description: pointDescription }, index) => (
                <motion.div
                  key={title}
                  variants={item}
                  initial="hidden"
                ...
                >
                  <span className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-green-600 to-emerald-600 text-white shadow-md shadow-green-600/25">
